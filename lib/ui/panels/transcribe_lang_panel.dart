/// Mic-side Language Selector for Transcribe mode: 23 languages x
/// {Native, Roman}. Opened by tapping the small language-selector icon
/// beside the mic (see [MicIndicator]) - never from the toolbar/Menu.
/// Writes to [KeyboardController.setTranscribeConfig], which is
/// completely independent of the general typing language/script.
library;
...
class TranscribeLangPanel extends StatelessWidget {
  const TranscribeLangPanel({super.key});
      ...
      child: Column(
        children: [
          Padding(
            ...
            child: Row(
              children: [
                ...
                Icon(Icons.mic_none, size: 15, color: t.icon),
          ...
          Padding(
            ...
            child: PanelTextField(hintText: 'Search languages'),
          ),
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, i) {
                  final lang = langs[i];
                  final selected = kb.transcribeLanguage.id == lang.id;
                  return InkWell(
                    onTap: () {
                      kb.setTranscribeConfig(lang, kb.transcribeStyle);
                      kb.closePanel();
                    },
  ...
  Widget _modeChip(
    ...
    final selected = kb.transcribeStyle == mode;
    return InkWell(
      onTap: () => kb.setTranscribeConfig(kb.transcribeLanguage, mode),
